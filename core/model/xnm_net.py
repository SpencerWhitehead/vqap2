...
import numpy as np
from . import xnm_modules as modules
from .questionEncoder import BiGRUEncoder
from .controller import Controller, x_softmax
...
class XNMNet(nn.Module):
    def __init__(self, **kwargs):
        ...
        controller_kwargs = {
            ...
            'is_norm_fc_module': self.is_norm_fc_module,  # True or False
            'temperature': self.temperature,  # 1, 10, 20, 100
        }
    ...
    def forward(self, questions, questions_len, vision_feat, relation_mask):
        ...
        for t in range(self.T_ctrl):
            ...
            if self.use_validity:
                ...
                module_invalidity = (1 - torch.round(module_validity)).to(torch.bool)
...
class Fusion(nn.Module):
    """
        ...
        [https://github.com/Cyanogenoid/vqa-counting/blob/master/vqa-v2/model.py#L73]
    """
    def __init__(self):
        super().__init__()
...
class Classifier(nn.Sequential):
    """
        Classifier follows: [https://github.com/Cyanogenoid/vqa-counting/blob/master/vqa-v2/model.py]
    """
