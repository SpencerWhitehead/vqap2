# Please see: [https://github.com/Cyanogenoid/vqa-counting/blob/master/vqa-v2/preprocess-features.py]
...
def main():
    ...
    parser.add_argument('--output_h5', default='data/objects/traineval_feature.h5', required=True)
